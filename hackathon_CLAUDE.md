...
- **Website / landing-web** — statik/kam-dinamik. Next.js yoki oddiy React + Vite. Backend shart bo'lmasligi mumkin. Vercel'ga bitta buyruq bilan deploy.
- **App (full-stack)** — frontend (Vercel) + backend (Render) + MongoDB. Avval backend'ning minimal API'sini (CRUD) tez qur, keyin frontend'ni ulaш.
...
## opencode — samarali, lekin ehtiyotkorlik bilan ishlatish
